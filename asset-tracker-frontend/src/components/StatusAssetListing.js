...
import { getAssetsByStatus, getVendorsAsset } from "../api/apiCalls";
        ...
        <div className="container">
          <div className="row ">
            <div className="col p-2">
              {
                <Link className="btn btn-sm btn-primary" to={`/asset-statuses`}>
                  Go to Statuses Page
                </Link>
              }
            </div>
            ...
            <div className="card-header text-center">
              <h3>
                {assetPages.page && content[0]
                  ? `Assets - ${content[0].status[0].statusName}`
                  : "Statuses"}{" "}
...
export default StatusAssetListing;
